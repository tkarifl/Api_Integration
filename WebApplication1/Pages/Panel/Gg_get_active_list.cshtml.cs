...
{
    public class Gg_get_active_listModel : PageModel
    {
        private readonly WebApplication1.Models.bitirme_test2_dbContext _context;

        public Gg_get_active_listModel(WebApplication1.Models.bitirme_test2_dbContext context)
        {
            _context = context;
        }
        ...
        public void OnGet()
        {
            ...
            {
                getProduct = service.Get_Products(Current_api_user.RoleUsername, Current_api_user.RolePassword, Current_api_user.ApiKey, Current_api_user.SecretKey,"A");
            }
            else
            {
